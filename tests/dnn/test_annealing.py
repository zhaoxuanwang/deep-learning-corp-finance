...
class TestAnnealingSchedule:
    ...
    def test_init_defaults(self):
        ...
        assert schedule.init == 1.0
        assert schedule.min == 0.01
        assert schedule.decay == 0.995
    ...
    def test_exponential_decay_deterministic(self):
        ...
        s1 = AnnealingSchedule(init=1.0, decay=0.9, min=0.01)
        s2 = AnnealingSchedule(init=1.0, decay=0.9, min=0.01)
    ...
    def test_monotone_decreasing(self):
        ...
        schedule = AnnealingSchedule(init=1.0, decay=0.9, min=0.001)
    ...
    def test_clamps_at_min(self):
        ...
        schedule = AnnealingSchedule(init=1.0, decay=0.5, min=0.1)
    ...
    def test_reaches_near_zero(self):
        ...
        schedule = AnnealingSchedule(init=1.0, min=0.01, decay=0.99)
    ...
    def test_reset(self):
        ...
        schedule = AnnealingSchedule(init=2.0)
    ...
    def test_get_set_state(self):
        ...
        schedule = AnnealingSchedule(init=1.0)
    ...
    def test_repr(self):
        ...
        schedule = AnnealingSchedule(init=1.0, min=0.01, schedule="exponential")
